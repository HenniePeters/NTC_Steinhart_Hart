...
#ifndef NDEBUG
        std::cout << "\n\nUnknown method, use SetMethod(NTC_AT_TOP) or SetMethod(NTC_AT_BOTTOM)\n\n";
#endif
        assert( Method >= NTC_TOP );
        assert( Method <= NTC_BOTTOM );
        return 0.0;
    }
...
#ifndef NDEBUG
        std::cout << "\n\nUnknown equation, did you modify the constructor?\n\n";
#endif
        return 0.0;
    }
